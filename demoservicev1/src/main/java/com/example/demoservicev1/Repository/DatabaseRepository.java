...
public class DatabaseRepository {
    ...
    public int registerUser(RegisterUserRequest registerUserRequest) {
        String insert_sql = "insert into users(username, first_name,last_name,pwd,hint) values (?,?,?,?,?)";
        return jdbcTemplate.update(insert_sql, registerUserRequest.getUserName(),
